...
function buildHooksJson(): string {
	...
	//
	// Always use bash-native commands — Claude Code hooks execute through bash
	// on ALL platforms (including Windows via MSYS/Git Bash). Using pwsh here
	// causes $ variable expansion bugs since bash eats $VAR before pwsh sees it.
